...
export const anatomicalStructures = [
  ...
  },
  {
    ...
    pinPosition: [-1.2, 0.8, -0.8],
    cameraTarget: [-1.0, 0.6, -0.6],
    color: "#f43f5e",
    opticalMetrics: {
  ...
  },
  {
    ...
    pinPosition: [0.9, 0.2, -1.75],
    cameraTarget: [0.7, 0.2, -1.5],
    color: "#fbbf24",
    opticalMetrics: {
  ...
  },
  {
    ...
    pinPosition: [0.9, 0.2, -2.8],
    cameraTarget: [0.9, 0.2, -2.4],
    color: "#fde047",
    opticalMetrics: {
