...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:Ma,depthTest:!1,depthWrite:!1})}function l1(s,e,i){const r=new Float32Array(zr),l=new J(0,1,0);return new Zi({name:"SphericalGaussianBlur",defines:{n:zr,CUBEUV_TEXEL_WIDTH:1/e,CUBEUV_TEXEL_HEIGHT:1/i,CUBEUV_MAX_MIP:`${s}.0`},uniforms:{envMap:{value:null},samples:{value:1},weights:{value:r},latitudinal:{value:!1},dTheta:{value:0},mipInt:{value:0},poleAxis:{value:l}},vertexShader:jc(),fragmentShader:`
		...
		`,blending:Ma,depthTest:!1,depthWrite:!1})}function Ov(){return new Zi({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:jc(),fragmentShader:`
		...
		`,blending:Ma,depthTest:!1,depthWrite:!1})}function Pv(){return new Zi({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:jc(),fragmentShader:`
	...
	`}class D_ extends Wi{constructor(e=1,i={}){super(e,e,i),this.isWebGLCubeRenderTarget=!0;const r={width:e,height:e,depth:1},l=[r,r,r,r,r,r];this.texture=new b_(l),this._setTextureOptions(i),this.texture.isRenderTargetTexture=!0}fromEquirectangularTexture(e,i){this.texture.type=i.type,this.texture.colorSpace=i.colorSpace,this.texture.generateMipmaps=i.generateMipmaps,this.texture.minFilter=i.minFilter,this.texture.magFilter=i.magFilter;const r={uniforms:{tEquirect:{value:null}},vertexShader:`
			...
			`},l=new Xs(5,5,5),u=new Zi({name:"CubemapFromEquirect",uniforms:Vs(r.uniforms),vertexShader:r.vertexShader,fragmentShader:r.fragmentShader,side:Qn,blending:Ma});u.uniforms.tEquirect.value=i;const h=new Wt(l,u),m=i.minFilter;return i.minFilter===Br&&(i.minFilter=zn),new dM(1,10,this).update(e,h),i.minFilter=m,h.geometry.dispose(),h.material.dispose(),this}clear(e,i=!0,r=!0,l=!0){const u=e.getRenderTarget();for(let h=0;h<6;h++)e.setRenderTarget(this,h),e.clear(i,r,l);e.setRenderTarget(u)}}function c1(s){let e=new WeakMap,i=new WeakMap,r=null;function l(g,M=!1){return g==null?null:M?h(g):u(g)}function u(g){if(g&&g.isTexture){const M=g.mapping;if(M===ch||M===uh)if(e.has(g)){const T=e.get(g).texture;return m(T,g.mapping)}else{const T=g.image;if(T&&T.height>0){const C=new D_(T.height);return C.fromEquirectangularTexture(s,g),e.set(g,C),g.addEventListener("dispose",d),m(C.texture,g.mapping)}else return null}}return g}function h(g){if(g&&g.isTexture){const M=g.mapping,T=M===ch||M===uh,C=M===Gr||M===Hs;if(T||C){let S=i.get(g);const x=S!==void 0?S.texture.pmremVersion:0;if(g.isRenderTargetTexture&&g.pmremVersion!==x)return r===null&&(r=new Nv(s)),S=T?r.fromEquirectangular(g,S):r.fromCubemap(g,S),S.texture.pmremVersion=g.pmremVersion,i.set(g,S),S.texture;if(S!==void 0)return S.texture;{const O=g.image;return T&&O&&O.height>0||C&&O&&p(O)?(r===null&&(r=new Nv(s)),S=T?r.fromEquirectangular(g):r.fromCubemap(g),S.texture.pmremVersion=g.pmremVersion,i.set(g,S),g.addEventListener("dispose",y),S.texture):null}}}return g}function m(g,M){return M===ch?g.mapping=Gr:M===uh&&(g.mapping=Hs),g}function p(g){let M=0;const T=6;for(let C=0;C<T;C++)g[C]!==void 0&&M++;return M===T}function d(g){const M=g.target;M.removeEventListener("dispose",d);const T=e.get(M);T!==void 0&&(e.delete(M),T.dispose())}function y(g){const M=g.target;M.removeEventListener("dispose",y);const T=i.get(M);T!==void 0&&(i.delete(M),T.dispose())}function _(){e=new WeakMap,i=new WeakMap,r!==null&&(r.dispose(),r=null)}return{get:l,dispose:_}}function u1(s){const e={};function i(r){if(e[r]!==void 0)return e[r];const l=s.getExtension(r);return e[r]=l,l}return{has:function(r){return i(r)!==null},init:function(){i("EXT_color_buffer_float"),i("WEBGL_clip_cull_distance"),i("OES_texture_float_linear"),i("EXT_color_buffer_half_float"),i("WEBGL_multisampled_render_to_texture"),i("WEBGL_render_shared_exponent")},get:function(r){const l=i(r);return l===null&&zs("WebGLRenderer: "+r+" extension not supported."),l}}}function f1(s,e,i,r){const l={},u=new WeakMap;function h(_){const g=_.target;g.index!==null&&e.remove(g.index);for(const T in g.attributes)e.remove(g.attributes[T]);g.removeEventListener("dispose",h),delete l[g.id];const M=u.get(g);M&&(e.remove(M),u.delete(g)),r.releaseStatesOfGeometry(g),g.isInstancedBufferGeometry===!0&&delete g._maxInstanceCount,i.memory.geometries--}function m(_,g){return l[g.id]===!0||(g.addEventListener("dispose",h),l[g.id]=!0,i.memory.geometries++),g}function p(_){const g=_.attributes;for(const M in g)e.update(g[M],s.ARRAY_BUFFER)}function d(_){const g=[],M=_.index,T=_.attributes.position;let C=0;if(T===void 0)return;if(M!==null){const O=M.array;C=M.version;for(let I=0,w=O.length;I<w;I+=3){const z=O[I+0],N=O[I+1],P=O[I+2];g.push(z,N,N,P,P,z)}}else{const O=T.array;C=T.version;for(let I=0,w=O.length/3-1;I<w;I+=3){const z=I+0,N=I+1,P=I+2;g.push(z,N,N,P,P,z)}}const S=new(T.count>=65535?S_:y_)(g,1);S.version=C;const x=u.get(_);x&&e.remove(x),u.set(_,S)}function y(_){const g=u.get(_);if(g){const M=_.index;M!==null&&g.version<M.version&&d(_)}else d(_);return u.get(_)}return{get:m,update:p,getWireframeAttribute:y}}function h1(s,e,i){let r;function l(_){r=_}let u,h;function m(_){u=_.type,h=_.bytesPerElement}function p(_,g){s.drawElements(r,g,u,_*h),i.update(g,r,1)}function d(_,g,M){M!==0&&(s.drawElementsInstanced(r,g,u,_*h,M),i.update(g,r,M))}function y(_,g,M){if(M===0)return;e.get("WEBGL_multi_draw").multiDrawElementsWEBGL(r,g,0,u,_,0,M);let C=0;for(let S=0;S<M;S++)C+=g[S];i.update(C,r,1)}this.setMode=l,this.setIndex=m,this.render=p,this.renderInstances=d,this.renderMultiDraw=y}function d1(s){const e={geometries:0,textures:0},i={frame:0,calls:0,triangles:0,points:0,lines:0};function r(u,h,m){switch(i.calls++,h){case s.TRIANGLES:i.triangles+=m*(u/3);break;case s.LINES:i.lines+=m*(u/2);break;case s.LINE_STRIP:i.lines+=m*(u-1);break;case s.LINE_LOOP:i.lines+=m*u;break;case s.POINTS:i.points+=m*u;break;default:Et("WebGLInfo: Unknown draw mode:",h);break}}function l(){i.calls=0,i.triangles=0,i.points=0,i.lines=0}return{memory:e,render:i,programs:null,autoReset:!0,reset:l,update:r}}function p1(s,e,i){const r=new WeakMap,l=new en;function u(h,m,p){const d=h.morphTargetInfluences,y=m.morphAttributes.position||m.morphAttributes.normal||m.morphAttributes.color,_=y!==void 0?y.length:0;let g=r.get(m);if(g===void 0||g.count!==_){let X=function(){E.dispose(),r.delete(m),m.removeEventListener("dispose",X)};var M=X;g!==void 0&&g.texture.dispose();const T=m.morphAttributes.position!==void 0,C=m.morphAttributes.normal!==void 0,S=m.morphAttributes.color!==void 0,x=m.morphAttributes.position||[],O=m.morphAttributes.normal||[],I=m.morphAttributes.color||[];let w=0;T===!0&&(w=1),C===!0&&(w=2),S===!0&&(w=3);let z=m.attributes.position.count*w,N=1;z>e.maxTextureSize&&(N=Math.ceil(z/e.maxTextureSize),z=e.maxTextureSize);const P=new Float32Array(z*N*4*_),E=new __(P,z,N,_);E.type=Vi,E.needsUpdate=!0;const D=w*4;for(let G=0;G<_;G++){const W=x[G],ce=O[G],me=I[G],Q=z*N*4*G;for(let B=0;B<W.count;B++){const H=B*D;T===!0&&(l.fromBufferAttribute(W,B),P[Q+H+0]=l.x,P[Q+H+1]=l.y,P[Q+H+2]=l.z,P[Q+H+3]=0),C===!0&&(l.fromBufferAttribute(ce,B),P[Q+H+4]=l.x,P[Q+H+5]=l.y,P[Q+H+6]=l.z,P[Q+H+7]=0),S===!0&&(l.fromBufferAttribute(me,B),P[Q+H+8]=l.x,P[Q+H+9]=l.y,P[Q+H+10]=l.z,P[Q+H+11]=me.itemSize===4?l.w:1)}}g={count:_,texture:E,size:new dt(z,N)},r.set(m,g),m.addEventListener("dispose",X)}if(h.isInstancedMesh===!0&&h.morphTexture!==null)p.getUniforms().setValue(s,"morphTexture",h.morphTexture,i);else{let T=0;for(let S=0;S<d.length;S++)T+=d[S];const C=m.morphTargetsRelative?1:1-T;p.getUniforms().setValue(s,"morphTargetBaseInfluence",C),p.getUniforms().setValue(s,"morphTargetInfluences",d)}p.getUniforms().setValue(s,"morphTargetsTexture",g.texture,i),p.getUniforms().setValue(s,"morphTargetsTextureSize",g.size)}return{update:u}}function m1(s,e,i,r,l){let u=new WeakMap;function h(d){const y=l.render.frame,_=d.geometry,g=e.get(d,_);if(u.get(g)!==y&&(e.update(g),u.set(g,y)),d.isInstancedMesh&&(d.hasEventListener("dispose",p)===!1&&d.addEventListener("dispose",p),u.get(d)!==y&&(i.update(d.instanceMatrix,s.ARRAY_BUFFER),d.instanceColor!==null&&i.update(d.instanceColor,s.ARRAY_BUFFER),u.set(d,y))),d.isSkinnedMesh){const M=d.skeleton;u.get(M)!==y&&(M.update(),u.set(M,y))}return g}function m(){u=new WeakMap}function p(d){const y=d.target;y.removeEventListener("dispose",p),r.releaseStatesOfObject(y),i.remove(y.instanceMatrix),y.instanceColor!==null&&i.remove(y.instanceColor)}return{update:h,dispose:m}}const g1={[i_]:"LINEAR_TONE_MAPPING",[a_]:"REINHARD_TONE_MAPPING",[r_]:"CINEON_TONE_MAPPING",[Fd]:"ACES_FILMIC_TONE_MAPPING",[o_]:"AGX_TONE_MAPPING",[l_]:"NEUTRAL_TONE_MAPPING",[s_]:"CUSTOM_TONE_MAPPING"};function v1(s,e,i,r,l,u){const h=new Wi(e,i,{type:s,depthBuffer:l,stencilBuffer:u,samples:r?4:0,depthTexture:l?new Gs(e,i):void 0}),m=new Wi(e,i,{type:Ta,depthBuffer:!1,stencilBuffer:!1}),p=new jn;p.setAttribute("position",new $t([-1,3,0,-1,-1,0,3,-1,0],3)),p.setAttribute("uv",new $t([0,2,0,0,2,0],2));const d=new oM({uniforms:{tDiffuse:{value:null}},vertexShader:`
			precision highp float;
			...
			void main() {
				...
				#endif
			}`,depthTest:!1,depthWrite:!1}),y=new Wt(p,d),_=new tp(-1,1,1,-1,0,1);let g=null,M=null,T=!1,C,S=null,x=[],O=!1;this.setSize=function(I,w){h.setSize(I,w),m.setSize(I,w);for(let z=0;z<x.length;z++){const N=x[z];N.setSize&&N.setSize(I,w)}},this.setEffects=function(I){x=I,O=x.length>0&&x[0].isRenderPass===!0;const w=h.width,z=h.height;for(let N=0;N<x.length;N++){const P=x[N];P.setSize&&P.setSize(w,z)}},this.begin=function(I,w){if(T||I.toneMapping===Xi&&x.length===0)return!1;if(S=w,w!==null){const z=w.width,N=w.height;(h.width!==z||h.height!==N)&&this.setSize(z,N)}return O===!1&&I.setRenderTarget(h),C=I.toneMapping,I.toneMapping=Xi,!0},this.hasRenderPass=function(){return O},this.end=function(I,w){I.toneMapping=C,T=!0;let z=h,N=m;for(let P=0;P<x.length;P++){const E=x[P];if(E.enabled!==!1&&(E.render(I,N,z,w),E.needsSwap!==!1)){const D=z;z=N,N=D}}if(g!==I.outputColorSpace||M!==I.toneMapping){g=I.outputColorSpace,M=I.toneMapping,d.defines={},bt.getTransfer(g)===Bt&&(d.defines.SRGB_TRANSFER="");const P=g1[M];P&&(d.defines[P]=""),d.needsUpdate=!0}d.uniforms.tDiffuse.value=z.texture,I.setRenderTarget(S),I.render(y,_),S=null,T=!1},this.isCompositing=function(){return T},this.dispose=function(){h.depthTexture&&h.depthTexture.dispose(),h.dispose(),m.dispose(),p.dispose(),d.dispose()}}const U_=new Bn,Pd=new Gs(1,1),N_=new __,L_=new BS,O_=new b_,Iv=[],zv=[],Bv=new Float32Array(16),Fv=new Float32Array(9),Hv=new Float32Array(4);function Ws(s,e,i){const r=s[0];if(r<=0||r>0)return s;const l=e*i;let u=Iv[l];if(u===void 0&&(u=new Float32Array(l),Iv[l]=u),e!==0){r.toArray(u,0);for(let h=1,m=0;h!==e;++h)m+=i,s[h].toArray(u,m)}return u}function Sn(s,e){if(s.length!==e.length)return!1;for(let i=0,r=s.length;i<r;i++)if(s[i]!==e[i])return!1;return!0}function Mn(s,e){for(let i=0,r=e.length;i<r;i++)s[i]=e[i]}function Jc(s,e){let i=zv[e];i===void 0&&(i=new Int32Array(e),zv[e]=i);for(let r=0;r!==e;++r)i[r]=s.allocateTextureUnit();return i}function _1(s,e){const i=this.cache;i[0]!==e&&(s.uniform1f(this.addr,e),i[0]=e)}function x1(s,e){const i=this.cache;if(e.x!==void 0)(i[0]!==e.x||i[1]!==e.y)&&(s.uniform2f(this.addr,e.x,e.y),i[0]=e.x,i[1]=e.y);else{if(Sn(i,e))return;s.uniform2fv(this.addr,e),Mn(i,e)}}function y1(s,e){const i=this.cache;if(e.x!==void 0)(i[0]!==e.x||i[1]!==e.y||i[2]!==e.z)&&(s.uniform3f(this.addr,e.x,e.y,e.z),i[0]=e.x,i[1]=e.y,i[2]=e.z);else if(e.r!==void 0)(i[0]!==e.r||i[1]!==e.g||i[2]!==e.b)&&(s.uniform3f(this.addr,e.r,e.g,e.b),i[0]=e.r,i[1]=e.g,i[2]=e.b);else{if(Sn(i,e))return;s.uniform3fv(this.addr,e),Mn(i,e)}}function S1(s,e){const i=this.cache;if(e.x!==void 0)(i[0]!==e.x||i[1]!==e.y||i[2]!==e.z||i[3]!==e.w)&&(s.uniform4f(this.addr,e.x,e.y,e.z,e.w),i[0]=e.x,i[1]=e.y,i[2]=e.z,i[3]=e.w);else{if(Sn(i,e))return;s.uniform4fv(this.addr,e),Mn(i,e)}}function M1(s,e){const i=this.cache,r=e.elements;if(r===void 0){if(Sn(i,e))return;s.uniformMatrix2fv(this.addr,!1,e),Mn(i,e)}else{if(Sn(i,r))return;Hv.set(r),s.uniformMatrix2fv(this.addr,!1,Hv),Mn(i,r)}}function b1(s,e){const i=this.cache,r=e.elements;if(r===void 0){if(Sn(i,e))return;s.uniformMatrix3fv(this.addr,!1,e),Mn(i,e)}else{if(Sn(i,r))return;Fv.set(r),s.uniformMatrix3fv(this.addr,!1,Fv),Mn(i,r)}}function E1(s,e){const i=this.cache,r=e.elements;if(r===void 0){if(Sn(i,e))return;s.uniformMatrix4fv(this.addr,!1,e),Mn(i,e)}else{if(Sn(i,r))return;Bv.set(r),s.uniformMatrix4fv(this.addr,!1,Bv),Mn(i,r)}}function T1(s,e){const i=this.cache;i[0]!==e&&(s.uniform1i(this.addr,e),i[0]=e)}function A1(s,e){const i=this.cache;if(e.x!==void 0)(i[0]!==e.x||i[1]!==e.y)&&(s.uniform2i(this.addr,e.x,e.y),i[0]=e.x,i[1]=e.y);else{if(Sn(i,e))return;s.uniform2iv(this.addr,e),Mn(i,e)}}function R1(s,e){const i=this.cache;if(e.x!==void 0)(i[0]!==e.x||i[1]!==e.y||i[2]!==e.z)&&(s.uniform3i(this.addr,e.x,e.y,e.z),i[0]=e.x,i[1]=e.y,i[2]=e.z);else{if(Sn(i,e))return;s.uniform3iv(this.addr,e),Mn(i,e)}}function C1(s,e){const i=this.cache;if(e.x!==void 0)(i[0]!==e.x||i[1]!==e.y||i[2]!==e.z||i[3]!==e.w)&&(s.uniform4i(this.addr,e.x,e.y,e.z,e.w),i[0]=e.x,i[1]=e.y,i[2]=e.z,i[3]=e.w);else{if(Sn(i,e))return;s.uniform4iv(this.addr,e),Mn(i,e)}}function w1(s,e){const i=this.cache;i[0]!==e&&(s.uniform1ui(this.addr,e),i[0]=e)}function D1(s,e){const i=this.cache;if(e.x!==void 0)(i[0]!==e.x||i[1]!==e.y)&&(s.uniform2ui(this.addr,e.x,e.y),i[0]=e.x,i[1]=e.y);else{if(Sn(i,e))return;s.uniform2uiv(this.addr,e),Mn(i,e)}}function U1(s,e){const i=this.cache;if(e.x!==void 0)(i[0]!==e.x||i[1]!==e.y||i[2]!==e.z)&&(s.uniform3ui(this.addr,e.x,e.y,e.z),i[0]=e.x,i[1]=e.y,i[2]=e.z);else{if(Sn(i,e))return;s.uniform3uiv(this.addr,e),Mn(i,e)}}function N1(s,e){const i=this.cache;if(e.x!==void 0)(i[0]!==e.x||i[1]!==e.y||i[2]!==e.z||i[3]!==e.w)&&(s.uniform4ui(this.addr,e.x,e.y,e.z,e.w),i[0]=e.x,i[1]=e.y,i[2]=e.z,i[3]=e.w);else{if(Sn(i,e))return;s.uniform4uiv(this.addr,e),Mn(i,e)}}function L1(s,e,i){const r=this.cache,l=i.allocateTextureUnit();r[0]!==l&&(s.uniform1i(this.addr,l),r[0]=l);let u;this.type===s.SAMPLER_2D_SHADOW?(Pd.compareFunction=i.isReversedDepthBuffer()?Yd:qd,u=Pd):u=U_,i.setTexture2D(e||u,l)}function O1(s,e,i){const r=this.cache,l=i.allocateTextureUnit();r[0]!==l&&(s.uniform1i(this.addr,l),r[0]=l),i.setTexture3D(e||L_,l)}function P1(s,e,i){const r=this.cache,l=i.allocateTextureUnit();r[0]!==l&&(s.uniform1i(this.addr,l),r[0]=l),i.setTextureCube(e||O_,l)}function I1(s,e,i){const r=this.cache,l=i.allocateTextureUnit();r[0]!==l&&(s.uniform1i(this.addr,l),r[0]=l),i.setTexture2DArray(e||N_,l)}function z1(s){switch(s){case 5126:return _1;case 35664:return x1;case 35665:return y1;case 35666:return S1;case 35674:return M1;case 35675:return b1;case 35676:return E1;case 5124:case 35670:return T1;case 35667:case 35671:return A1;case 35668:case 35672:return R1;case 35669:case 35673:return C1;case 5125:return w1;case 36294:return D1;case 36295:return U1;case 36296:return N1;case 35678:case 36198:case 36298:case 36306:case 35682:return L1;case 35679:case 36299:case 36307:return O1;case 35680:case 36300:case 36308:case 36293:return P1;case 36289:case 36303:case 36311:case 36292:return I1}}function B1(s,e){s.uniform1fv(this.addr,e)}function F1(s,e){const i=Ws(e,this.size,2);s.uniform2fv(this.addr,i)}function H1(s,e){const i=Ws(e,this.size,3);s.uniform3fv(this.addr,i)}function G1(s,e){const i=Ws(e,this.size,4);s.uniform4fv(this.addr,i)}function V1(s,e){const i=Ws(e,this.size,4);s.uniformMatrix2fv(this.addr,!1,i)}function k1(s,e){const i=Ws(e,this.size,9);s.uniformMatrix3fv(this.addr,!1,i)}function X1(s,e){const i=Ws(e,this.size,16);s.uniformMatrix4fv(this.addr,!1,i)}function W1(s,e){s.uniform1iv(this.addr,e)}function q1(s,e){s.uniform2iv(this.addr,e)}function Y1(s,e){s.uniform3iv(this.addr,e)}function Z1(s,e){s.uniform4iv(this.addr,e)}function K1(s,e){s.uniform1uiv(this.addr,e)}function Q1(s,e){s.uniform2uiv(this.addr,e)}function j1(s,e){s.uniform3uiv(this.addr,e)}function J1(s,e){s.uniform4uiv(this.addr,e)}function $1(s,e,i){const r=this.cache,l=e.length,u=Jc(i,l);Sn(r,u)||(s.uniform1iv(this.addr,u),Mn(r,u));let h;this.type===s.SAMPLER_2D_SHADOW?h=Pd:h=U_;for(let m=0;m!==l;++m)i.setTexture2D(e[m]||h,u[m])}function eT(s,e,i){const r=this.cache,l=e.length,u=Jc(i,l);Sn(r,u)||(s.uniform1iv(this.addr,u),Mn(r,u));for(let h=0;h!==l;++h)i.setTexture3D(e[h]||L_,u[h])}function tT(s,e,i){const r=this.cache,l=e.length,u=Jc(i,l);Sn(r,u)||(s.uniform1iv(this.addr,u),Mn(r,u));for(let h=0;h!==l;++h)i.setTextureCube(e[h]||O_,u[h])}function nT(s,e,i){const r=this.cache,l=e.length,u=Jc(i,l);Sn(r,u)||(s.uniform1iv(this.addr,u),Mn(r,u));for(let h=0;h!==l;++h)i.setTexture2DArray(e[h]||N_,u[h])}function iT(s){switch(s){case 5126:return B1;case 35664:return F1;case 35665:return H1;case 35666:return G1;case 35674:return V1;case 35675:return k1;case 35676:return X1;case 5124:case 35670:return W1;case 35667:case 35671:return q1;case 35668:case 35672:return Y1;case 35669:case 35673:return Z1;case 5125:return K1;case 36294:return Q1;case 36295:return j1;case 36296:return J1;case 35678:case 36198:case 36298:case 36306:case 35682:return $1;case 35679:case 36299:case 36307:return eT;case 35680:case 36300:case 36308:case 36293:return tT;case 36289:case 36303:case 36311:case 36292:return nT}}class aT{constructor(e,i,r){this.id=e,this.addr=r,this.cache=[],this.type=i.type,this.setValue=z1(i.type)}}class rT{constructor(e,i,r){this.id=e,this.addr=r,this.cache=[],this.type=i.type,this.size=i.size,this.setValue=iT(i.type)}}class sT{constructor(e){this.id=e,this.seq=[],this.map={}}setValue(e,i,r){const l=this.seq;for(let u=0,h=l.length;u!==h;++u){const m=l[u];m.setValue(e,i[m.id],r)}}}const Vh=/(\w+)(\])?(\[|\.)?/g;function Gv(s,e){s.seq.push(e),s.map[e.id]=e}function oT(s,e,i){const r=s.name,l=r.length;for(Vh.lastIndex=0;;){const u=Vh.exec(r),h=Vh.lastIndex;let m=u[1];const p=u[2]==="]",d=u[3];if(p&&(m=m|0),d===void 0||d==="["&&h+2===l){Gv(i,d===void 0?new aT(m,s,e):new rT(m,s,e));break}else{let _=i.map[m];_===void 0&&(_=new sT(m),Gv(i,_)),i=_}}}class Gc{constructor(e,i){this.seq=[],this.map={};const r=e.getProgramParameter(i,e.ACTIVE_UNIFORMS);for(let h=0;h<r;++h){const m=e.getActiveUniform(i,h),p=e.getUniformLocation(i,m.name);oT(m,p,this)}const l=[],u=[];for(const h of this.seq)h.type===e.SAMPLER_2D_SHADOW||h.type===e.SAMPLER_CUBE_SHADOW||h.type===e.SAMPLER_2D_ARRAY_SHADOW?l.push(h):u.push(h);l.length>0&&(this.seq=l.concat(u))}setValue(e,i,r,l){const u=this.map[i];u!==void 0&&u.setValue(e,r,l)}setOptional(e,i,r){const l=i[r];l!==void 0&&this.setValue(e,r,l)}static upload(e,i,r,l){for(let u=0,h=i.length;u!==h;++u){const m=i[u],p=r[m.id];p.needsUpdate!==!1&&m.setValue(e,p.value,l)}}static seqWithValue(e,i){const r=[];for(let l=0,u=e.length;l!==u;++l){const h=e[l];h.id in i&&r.push(h)}return r}}function Vv(s,e,i){const r=s.createShader(e);return s.shaderSource(r,i),s.compileShader(r),r}const lT=37297;let cT=0;function uT(s,e){const i=s.split(`
`),r=[],l=Math.max(e-6,0),u=Math.min(e+6,i.length);for(let h=l;h<u;h++){const m=h+1;r.push(`${m===e?">":" "} ${m}: ${i[h]}`)}return r.join(`
`)}const kv=new st;function fT(s){bt._getMatrix(kv,bt.workingColorSpace,s);const e=`mat3( ${kv.elements.map(i=>i.toFixed(4))} )`;switch(bt.getTransfer(s)){case Wc:return[e,"LinearTransferOETF"];case Bt:return[e,"sRGBTransferOETF"];default:return nt("WebGLProgram: Unsupported color space: ",s),[e,"LinearTransferOETF"]}}function Xv(s,e,i){const r=s.getShaderParameter(e,s.COMPILE_STATUS),u=(s.getShaderInfoLog(e)||"").trim();if(r&&u==="")return"";const h=/ERROR: 0:(\d+)/.exec(u);if(h){const m=parseInt(h[1]);return i.toUpperCase()+`

`+u+`

`+uT(s.getShaderSource(e),m)}else return u}function hT(s,e){const i=fT(e);return[`vec4 ${s}( vec4 value ) {`,`	return ${i[1]}( vec4( value.rgb * ${i[0]}, value.a ) );`,"}"].join(`
`)}const dT={[i_]:"Linear",[a_]:"Reinhard",[r_]:"Cineon",[Fd]:"ACESFilmic",[o_]:"AgX",[l_]:"Neutral",[s_]:"Custom"};function pT(s,e){const i=dT[e];return i===void 0?(nt("WebGLProgram: Unsupported toneMapping:",e),"vec3 "+s+"( vec3 color ) { return LinearToneMapping( color ); }"):"vec3 "+s+"( vec3 color ) { return "+i+"ToneMapping( color ); }"}const Oc=new J;function mT(){bt.getLuminanceCoefficients(Oc);const s=Oc.x.toFixed(4),e=Oc.y.toFixed(4),i=Oc.z.toFixed(4);return["float luminance( const in vec3 rgb ) {",`	const vec3 weights = vec3( ${s}, ${e}, ${i} );`,"	return dot( weights, rgb );","}"].join(`
`)}function gT(s){return[s.extensionClipCullDistance?"#extension GL_ANGLE_clip_cull_distance : require":"",s.extensionMultiDraw?"#extension GL_ANGLE_multi_draw : require":""].filter(Yo).join(`
`)}function vT(s){const e=[];for(const i in s){const r=s[i];r!==!1&&e.push("#define "+i+" "+r)}return e.join(`
`)}function _T(s,e){const i={},r=s.getProgramParameter(e,s.ACTIVE_ATTRIBUTES);for(let l=0;l<r;l++){const u=s.getActiveAttrib(e,l),h=u.name;let m=1;u.type===s.FLOAT_MAT2&&(m=2),u.type===s.FLOAT_MAT3&&(m=3),u.type===s.FLOAT_MAT4&&(m=4),i[h]={type:u.type,location:s.getAttribLocation(e,h),locationSize:m}}return i}function Yo(s){return s!==""}function Wv(s,e){const i=e.numSpotLightShadows+e.numSpotLightMaps-e.numSpotLightShadowsWithMaps;return s.replace(/NUM_DIR_LIGHTS/g,e.numDirLights).replace(/NUM_SPOT_LIGHTS/g,e.numSpotLights).replace(/NUM_SPOT_LIGHT_MAPS/g,e.numSpotLightMaps).replace(/NUM_SPOT_LIGHT_COORDS/g,i).replace(/NUM_RECT_AREA_LIGHTS/g,e.numRectAreaLights).replace(/NUM_POINT_LIGHTS/g,e.numPointLights).replace(/NUM_HEMI_LIGHTS/g,e.numHemiLights).replace(/NUM_DIR_LIGHT_SHADOWS/g,e.numDirLightShadows).replace(/NUM_SPOT_LIGHT_SHADOWS_WITH_MAPS/g,e.numSpotLightShadowsWithMaps).replace(/NUM_SPOT_LIGHT_SHADOWS/g,e.numSpotLightShadows).replace(/NUM_POINT_LIGHT_SHADOWS/g,e.numPointLightShadows)}function qv(s,e){return s.replace(/NUM_CLIPPING_PLANES/g,e.numClippingPlanes).replace(/UNION_CLIPPING_PLANES/g,e.numClippingPlanes-e.numClipIntersection)}const xT=/^[ \t]*#include +<([\w\d./]+)>/gm;function Id(s){return s.replace(xT,ST)}const yT=new Map;function ST(s,e){let i=ht[e];if(i===void 0){const r=yT.get(e);if(r!==void 0)i=ht[r],nt('WebGLRenderer: Shader chunk "%s" has been deprecated. Use "%s" instead.',e,r);else throw new Error("THREE.WebGLProgram: Can not resolve #include <"+e+">")}return Id(i)}const MT=/#pragma unroll_loop_start\s+for\s*\(\s*int\s+i\s*=\s*(\d+)\s*;\s*i\s*<\s*(\d+)\s*;\s*i\s*\+\+\s*\)\s*{([\s\S]+?)}\s+#pragma unroll_loop_end/g;function Yv(s){return s.replace(MT,bT)}function bT(s,e,i,r){let l="";for(let u=parseInt(e);u<parseInt(i);u++)l+=r.replace(/\[\s*i\s*\]/g,"[ "+u+" ]").replace(/UNROLLED_LOOP_INDEX/g,u);return l}function Zv(s){let e=`precision ${s.precision} float;
...
#define LOW_PRECISION`),e}const ET={[Ic]:"SHADOWMAP_TYPE_PCF",[qo]:"SHADOWMAP_TYPE_VSM"};function TT(s){return ET[s.shadowMapType]||"SHADOWMAP_TYPE_BASIC"}const AT={[Gr]:"ENVMAP_TYPE_CUBE",[Hs]:"ENVMAP_TYPE_CUBE",[Kc]:"ENVMAP_TYPE_CUBE_UV"};function RT(s){return s.envMap===!1?"ENVMAP_TYPE_CUBE":AT[s.envMapMode]||"ENVMAP_TYPE_CUBE"}const CT={[Hs]:"ENVMAP_MODE_REFRACTION"};function wT(s){return s.envMap===!1?"ENVMAP_MODE_REFLECTION":CT[s.envMapMode]||"ENVMAP_MODE_REFLECTION"}const DT={[n_]:"ENVMAP_BLENDING_MULTIPLY",[vS]:"ENVMAP_BLENDING_MIX",[_S]:"ENVMAP_BLENDING_ADD"};function UT(s){return s.envMap===!1?"ENVMAP_BLENDING_NONE":DT[s.combine]||"ENVMAP_BLENDING_NONE"}function NT(s){const e=s.envMapCubeUVHeight;if(e===null)return null;const i=Math.log2(e)-2,r=1/e;return{texelWidth:1/(3*Math.max(Math.pow(2,i),112)),texelHeight:r,maxMip:i}}function LT(s,e,i,r){const l=s.getContext(),u=i.defines;let h=i.vertexShader,m=i.fragmentShader;const p=TT(i),d=RT(i),y=wT(i),_=UT(i),g=NT(i),M=gT(i),T=vT(u),C=l.createProgram();let S,x,O=i.glslVersion?"#version "+i.glslVersion+`
...
`)+`
`+x);const I=O+S+h,w=O+x+m,z=Vv(l,l.VERTEX_SHADER,I),N=Vv(l,l.FRAGMENT_SHADER,w);l.attachShader(C,z),l.attachShader(C,N),i.index0AttributeName!==void 0?l.bindAttribLocation(C,0,i.index0AttributeName):i.hasPositionAttribute===!0&&l.bindAttribLocation(C,0,"position"),l.linkProgram(C);function P(G){if(s.debug.checkShaderErrors){const W=l.getProgramInfoLog(C)||"",ce=l.getShaderInfoLog(z)||"",me=l.getShaderInfoLog(N)||"",Q=W.trim(),B=ce.trim(),H=me.trim();let $=!0,fe=!0;if(l.getProgramParameter(C,l.LINK_STATUS)===!1)if($=!1,typeof s.debug.onShaderError=="function")s.debug.onShaderError(l,C,z,N);else{const Ee=Xv(l,z,"vertex"),L=Xv(l,N,"fragment");Et("WebGLProgram: Shader Error "+l.getError()+" - VALIDATE_STATUS "+l.getProgramParameter(C,l.VALIDATE_STATUS)+`
